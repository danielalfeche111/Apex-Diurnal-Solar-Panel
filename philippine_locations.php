<?php
// Philippine Provinces and Cities/Municipalities Data (PSGC Standard)
// Shared across frontend modal and backend lead endpoints

$consultProvinceCityMap = [
  ...
  'Batangas' => ['Agoncillo', 'Alitagtag', 'Balayan', 'Balete', 'Batangas City', 'Bauan', 'Calaca', 'Calatagan', 'Cuenca', 'Ibaan', 'Laurel', 'Lemery', 'Lian', 'Lipa City', 'Lobo', 'Mabini', 'Malvar', 'Mataasnakahoy', 'Nasugbu', 'Padre Garcia', 'Rosario', 'San Jose', 'San Juan', 'San Luis', 'San Nicolas', 'San Pascual', 'Santa Teresita', 'Sto. Tomas City', 'Taal', 'Talisay', 'Tanauan City', 'Taysan', 'Tingloy', 'Tuy'],
  ...
  'Camarines Sur' => ['Baao', 'Balatan', 'Bato', 'Bombon', 'Buhi', 'Bula', 'Cabusao', 'Calabanga', 'Camaligan', 'Canaman', 'Caramoan', 'Del Gallego', 'Gainza', 'Garchitorena', 'Goa', 'Iriga City', 'Lagonoy', 'Libmanan', 'Lupi', 'Magarao', 'Milaor', 'Minalabac', 'Nabua', 'Naga City (Camarines Sur)', 'Ocampo', 'Pamplona', 'Pasacao', 'Pili', 'Presentacion', 'Ragay', 'Sagñay', 'San Fernando', 'San Jose', 'Sipocot', 'Siruma', 'Tigaon', 'Tinambac'],
  ...
  'Cavite' => ['Alfonso', 'Amadeo', 'Bacoor City', 'Carmona', 'Cavite City', 'Dasmariñas City', 'Gen. Mariano Alvarez', 'General Emilio Aguinaldo', 'General Trias City', 'Imus City', 'Indang', 'Kawit', 'Magallanes', 'Maragondon', 'Mendez', 'Naic', 'Noveleta', 'Rosario', 'Silang', 'Tagaytay City', 'Tanza', 'Ternate', 'Trece Martires City'],
  'Cebu' => ['Alcantara', 'Alcoy', 'Alegria', 'Aloguinsan', 'Argao', 'Asturias', 'Badian', 'Balamban', 'Bantayan', 'Barili', 'Bogo City', 'Boljoon', 'Borbon', 'Carcar City', 'Carmen', 'Catmon', 'Cebu City', 'Compostela', 'Consolacion', 'Cordova', 'Daanbantayan', 'Dalaguete', 'Danao City', 'Dumanjug', 'Ginatilan', 'Lapu-Lapu City', 'Liloan', 'Madridejos', 'Malabuyoc', 'Mandaue City', 'Medellin', 'Minglanilla', 'Moalboal', 'Naga City (Cebu)', 'Oslob', 'Pilar', 'Pinamungajan', 'Poro', 'Ronda', 'Samboan', 'San Fernando', 'San Francisco', 'San Remigio', 'Santa Fe', 'Santander', 'Sibonga', 'Sogod', 'Tabogon', 'Tabuelan', 'Talisay City (Cebu)', 'Toledo City', 'Tuburan', 'Tudela'],
  ...
  'La Union' => ['Agoo', 'Aringay', 'Bacnotan', 'Bagulin', 'Balaoan', 'Bangar', 'Bauang', 'Burgos', 'Caba', 'Luna', 'Naguilian', 'Pugo', 'Rosario', 'San Fernando City (La Union)', 'San Gabriel', 'San Juan', 'Santo Tomas', 'Santol', 'Sudipen', 'Tubao'],
  ...
  'Metro Manila (NCR)' => ['Caloocan', 'Caloocan City', 'Las Piñas', 'Las Piñas City', 'Makati', 'Makati City', 'Malabon', 'Malabon City', 'Mandaluyong', 'Mandaluyong City', 'Manila', 'Marikina', 'Marikina City', 'Muntinlupa', 'Muntinlupa City', 'Navotas', 'Navotas City', 'Parañaque', 'Parañaque City', 'Pasay', 'Pasay City', 'Pasig', 'Pasig City', 'Pateros', 'Quezon City', 'San Juan', 'San Juan City', 'Taguig', 'Taguig City', 'Valenzuela', 'Valenzuela City'],
  ...
  'Negros Occidental' => ['Bacolod City', 'Bago City', 'Binalbagan', 'Cadiz City', 'Calatrava', 'Candoni', 'Cauayan', 'Enrique B. Magalona', 'Escalante City', 'Himamaylan City', 'Hinigaran', 'Hinoba-An', 'Ilog', 'Isabela', 'Kabankalan City', 'La Carlota City', 'La Castellana', 'Manapla', 'Moises Padilla', 'Murcia', 'Pontevedra', 'Pulupandan', 'Sagay City', 'Salvador Benedicto', 'San Carlos City (Negros Occidental)', 'San Enrique', 'Silay City', 'Sipalay City', 'Talisay City (Negros Occidental)', 'Toboso', 'Valladolid', 'Victorias City'],
  ...
  'Pampanga' => ['Angeles City', 'Apalit', 'Arayat', 'Bacolor', 'Candaba', 'Floridablanca', 'Guagua', 'Lubao', 'Mabalacat City', 'Macabebe', 'Magalang', 'Masantol', 'Mexico', 'Minalin', 'Porac', 'San Fernando City (Pampanga)', 'San Luis', 'San Simon', 'Santa Ana', 'Santa Rita', 'Sasmuan', 'Sto. Tomas'],
  'Pangasinan' => ['Agno', 'Aguilar', 'Alaminos City', 'Alcala', 'Anda', 'Asingan', 'Balungao', 'Bani', 'Basista', 'Bautista', 'Bayambang', 'Binalonan', 'Binmaley', 'Bolinao', 'Bugallon', 'Burgos', 'Calasiao', 'Dagupan City', 'Dasol', 'Infanta', 'Labrador', 'Laoac', 'Lingayen', 'Mabini', 'Malasiqui', 'Manaoag', 'Mangaldan', 'Mangatarem', 'Mapandan', 'Natividad', 'Pozorrubio', 'Rosales', 'San Carlos City (Pangasinan)', 'San Fabian', 'San Jacinto', 'San Manuel', 'San Nicolas', 'San Quintin', 'Santa Barbara', 'Santa Maria', 'Santo Tomas', 'Sison', 'Sual', 'Tayug', 'Umingan', 'Urbiztondo', 'Urdaneta City', 'Villasis'],
  ...
  'Zamboanga del Norte' => ['Bacungan', 'Baliguian', 'Dapitan City', 'Dipolog City', 'Godod', 'Gutalac', 'Jose Dalman', 'Kalawit', 'Katipunan', 'La Libertad', 'Labason', 'Liloy', 'Manukan', 'Mutia', 'Piñan', 'Polanco', 'Pres. Manuel a. Roxas', 'Rizal', 'Salug', 'Sergio osmeña Sr.', 'Siayan', 'Sibuco', 'Sibutad', 'Sindangan', 'Siocon', 'Sirawai', 'Tampilisan'],
...
// Provide aliases for Metro Manila naming variations
$consultProvinceCityMap['Metro Manila'] = $consultProvinceCityMap['Metro Manila (NCR)'];
$consultProvinceCityMap['NCR'] = $consultProvinceCityMap['Metro Manila (NCR)'];

$philippine_provinces = array_keys($consultProvinceCityMap);
sort($philippine_provinces);

$allEntries = [];
foreach ($consultProvinceCityMap as $list) {
  $allEntries = array_merge($allEntries, $list);
}
$philippine_cities = array_values(array_unique($allEntries));
sort($philippine_cities);

$consult_provinces = $philippine_provinces;
$consult_cities = $philippine_cities;

$consultCityProvinceMap = [];
foreach ($consultProvinceCityMap as $prov => $cities) {
  foreach ($cities as $ct) {
    $consultCityProvinceMap[$ct] = $prov;
  }
}

if (!function_exists('checkCityMatchesProvince')) {
  function checkCityMatchesProvince(string $city, string $province, array $map): bool {
    if (!isset($map[$province])) return false;
    $cities = $map[$province];
    if (in_array($city, $cities, true)) return true;
    $stripped = preg_replace('/\s+City$/i', '', $city);
    $withCity = $stripped . ' City';
    return in_array($stripped, $cities, true) || in_array($withCity, $cities, true);
  }
}
