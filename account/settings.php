    ...
    if ($action === 'update_profile') {
        ...
        if (empty($profile_errors)) {
            if ($currentUser->updateProfile($clean)) {
                $profile_success_message = 'Your delivery profile has been successfully saved!';
...
<body>
    ...
    <main class="settings-page">
        <div class="settings-wrapper">
            ...
            <div class="settings-card">
                <div class="settings-card-header">
                    ...
                    <div>
                        ...
                        <div class="settings-card-desc">Your personal account credentials</div>
                    </div>
                </div>
            ...
            <!-- Delivery & Shipping Profile Card -->
            <div class="settings-card" id="profile-details">
                <div class="settings-card-header">
                    ...
                    <div>
                        <div class="settings-card-title">Default Delivery &amp; Shipping Profile</div>
                        <div class="settings-card-desc">Automatically pre-fills your checkout for faster, 1-click orders</div>
                    </div>
                </div>
                ...
                <div class="profile-progress-wrap">
                    <div class="profile-progress-header">
                        <span class="profile-progress-title">Profile Completion</span>
                        <span class="profile-progress-val"><?php echo (int)($profile['completion_percentage'] ?? 0); ?>%</span>
                    </div>
                    <div class="profile-progress-bar">
                        <div class="profile-progress-fill" style="width: <?php echo (int)($profile['completion_percentage'] ?? 0); ?>%;"></div>
                    </div>
                    <div class="profile-progress-hint">
                        <?php if (!empty($profile['is_complete'])): ?>
                            <span style="color:#166534; font-weight:600;">✓ Your profile is 100% complete! Checkout forms will be fully auto-filled.</span>
                        <?php else: ?>
                            Complete your shipping details below to activate automatic checkout pre-filling.
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <form method="POST" action="settings.php#profile-details">
                    ...
                    <div class="form-row-2">
                        <div class="form-group">
                            <label for="profile_full_name" class="form-label">Full Name <span style="color:#dc2626;">*</span></label>
                            <div class="input-group">
                                ...
                                <input type="text" id="profile_full_name" name="full_name" class="form-control" placeholder="e.g. Juan dela Cruz" value="<?php echo htmlspecialchars($profile['full_name'] ?? ''); ?>" required>
                            </div>
                        </div>
                    ...
                    <div class="form-row-2">
                        <div class="form-group">
                            <label for="profile_province" class="form-label">Province <span style="color:#dc2626;">*</span></label>
                            <div class="input-group">
                                <svg class="input-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"></polygon><line x1="8" y1="2" x2="8" y2="18"></line><line x1="16" y1="6" x2="16" y2="22"></line></svg>
                        ...
                        <div class="form-group">
                            <label for="profile_city" class="form-label">City / Municipality <span style="color:#dc2626;">*</span></label>
                            <div class="input-group">
                                <svg class="input-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21h18M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16"></path></svg>
                                <select id="profile_city" name="city" class="form-control form-select" required>
                                    <option value=""><?php echo !empty($profile['province']) ? 'Select City / Municipality' : 'Select Province First'; ?></option>
                                    <?php
                    ...
                    <div class="form-group">
                        <label for="profile_street_address" class="form-label">Street Address / House No. / Barangay <span style="color:#dc2626;">*</span></label>
                        <div class="input-group">
                            <svg class="input-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                            <input type="text" id="profile_street_address" name="street_address" class="form-control" placeholder="e.g. Unit 4B, 123 Solar Avenue, Brgy. San Isidro" value="<?php echo htmlspecialchars($profile['street_address'] ?? ''); ?>" required>
                        </div>
                    </div>

                    <div class="form-row-2">
                        <div class="form-group">
                            <label for="profile_postal_code" class="form-label">Postal Code <span style="color:#dc2626;">*</span></label>
                            <div class="input-group">
                                <svg class="input-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="16" rx="2"></rect><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                <input type="text" id="profile_postal_code" name="postal_code" class="form-control" placeholder="e.g. 1000" maxlength="4" pattern="\d{4}" inputmode="numeric" value="<?php echo htmlspecialchars($profile['postal_code'] ?? ''); ?>" required oninput="this.value=this.value.replace(/\D/g,'').slice(0,4)">
                            </div>
                        </div>

                        <div class="form-group" style="display:flex; flex-direction:column; justify-content:center; padding-top:14px;">
                            <label style="display:flex; align-items:center; gap:8px; cursor:pointer; font-size:0.9rem; font-weight:600; color:var(--color-navy);">
                                <input type="checkbox" name="is_default_shipping" value="1" <?php echo !empty($profile['is_default_shipping']) ? 'checked' : 'checked'; ?> style="width:1.15rem; height:1.15rem; accent-color:var(--color-navy); cursor:pointer;">
                                <span>Set as default shipping address</span>
                            </label>
                            <label style="display:flex; align-items:center; gap:8px; cursor:pointer; font-size:0.9rem; font-weight:600; color:var(--color-navy); margin-top:8px;">
                                <input type="checkbox" name="is_default_billing" value="1" <?php echo !empty($profile['is_default_billing']) ? 'checked' : 'checked'; ?> style="width:1.15rem; height:1.15rem; accent-color:var(--color-navy); cursor:pointer;">
