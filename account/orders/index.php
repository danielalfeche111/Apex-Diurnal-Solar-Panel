                        ...
                        <?php foreach ($initialOrders as $ord): ?>
                            <tr data-order-id="<?php echo (int) $ord['id']; ?>">
                                ...
                                <td style="text-align: right; white-space: nowrap;">
                                    <a href="../../cart/receipt.php?id=<?php echo (int) $ord['id']; ?>" class="btn-view-receipt-link" style="color:var(--color-navy); font-size:0.86rem; font-weight:700; text-decoration:none; margin-right:12px; display:inline-flex; align-items:center; gap:4px;" title="View Receipt">
